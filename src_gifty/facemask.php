...
<!-- !PAGE CONTENT! -->
<div style="margin-left:15.2rem;margin-right:4rem;" >
...
<!-- Top menu on small screens -->
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Customized Face Masks</p>
  </header>

  <!-- Image header -->
  <div class="w3-display-container w3-container" id="welcome">
    <img src="2.jpg" alt="Face masks" style="width:100%">
    <div class="w3-display-topleft w3-text-white" style="padding:24px 48px">
      <h1 class="w3-jumbo w3-hide-small">New arrivals</h1>
      <h1 class="w3-hide-large w3-hide-medium">New arrivals</h1>
      <h1 class="w3-hide-small">COLLECTION 2020</h1>
      <p><a href="#face-masks" class="w3-button w3-black w3-padding-large w3-large"><img src="shopping.png" alt="" style="width:2rem; float:right;" >SHOP NOW </a></p>
    </div>
  </div>
<hr>
<!-- !PAGE CONTENT! -->
...
<div style="margin-left:4rem;margin-right:4rem;float:left;" >
