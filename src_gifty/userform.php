...
<!-- Navigationbar     -->
   <nav class="navbar"style="z-index:10;position:fixed;">
  <ul class="navbar-nav">
    ...
    <div class="topleft" style="margin-left:250px">
    <a href="home.php"><img src="logo.png" style="width:150px"></a> 
  </div>
 ...
 <section class="forms-section">
  ...
  <h1 class="section-title">Let's get to know each other!</h1>

  

      <form class="form" method='POST' action='up.php'>
        <fieldset>
